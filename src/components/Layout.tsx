  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-dark-bg text-zinc-800 dark:text-zinc-200 transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <header className="h-16 px-8 border-b border-zinc-200/50 dark:border-zinc-800/50 flex items-center justify-between sticky top-0 bg-white/70 dark:bg-dark-bg/70 backdrop-blur-md z-20">
